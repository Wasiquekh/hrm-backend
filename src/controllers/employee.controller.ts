    ...
    upload.fields([
      ...
      try {
        ...
        if ((existingEmployee as any[]).length > 0) {
          ...
          else if (duplicate.mobile === employeeData.mobile)
            duplicateField = "Mobile";
          else if (duplicate.account_number === employeeData.account_number)
            duplicateField = "Account number";
          else if (duplicate.pan_number === employeeData.pan_number)
            duplicateField = "PAN number";
          else if (duplicate.aadhar_number === employeeData.aadhar_number)
        ...
        await sequelize.query(
          ...
          )`,
          {
            replacements: {
              ...
              email: employeeData.email,
              mobile: employeeData.mobile,
              alternate_mobile: toNull(employeeData.alternate_mobile),
              address: employeeData.address,
              city: employeeData.city,
              state: employeeData.state,
              blood_group: toNull(employeeData.blood_group),
              qualification: toNull(employeeData.qualification),
              department_id: toNull(employeeData.department_id),
              designation_id: toNull(employeeData.designation_id),
              date_of_joining: employeeData.date_of_joining,
              salary: employeeData.salary,
              overtime_per_day: employeeData.overtime_per_day,
              travel_allowance: employeeData.travel_allowance,
              account_number: employeeData.account_number,
        ...
        // Upload documents - UPDATED WITH CORRECT DATABASE TYPES
        const documentTypes = [
          "profile_photo", // maps to employee_photo
          "pan_card",
          "cv",
          "bank_details",
          "aadhar_front", // maps to aadhar_card
          "degree_cert", // maps to degree_certificate
          "light_bill",
        ];

        for (const docType of documentTypes) {
          // Map frontend field names to database document types
          let frontendField = docType;
          if (docType === "profile_photo") frontendField = "employee_photo";
          if (docType === "aadhar_front") frontendField = "aadhar_card";
          if (docType === "degree_cert") frontendField = "degree_certificate";

          const fileList = files[frontendField];
        ...
        // Get employee with department and designation names
      ...
      try {
        ...
        updatableFields.forEach((field) => {
          if (updateData[field] !== undefined) {
            ...
            // Apply toNull for nullable fields
            if (
              ...
              replacements[field] = toNull(updateData[field]);
            } else {
        ...
        // Handle document updates - UPDATED WITH CORRECT DATABASE TYPES
        const documentTypes = [
          "profile_photo", // maps to employee_photo
          "pan_card",
          "cv",
        ...
        // Get updated employee with department and designation names
